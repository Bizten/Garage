...
class VisitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visit" do
    assert_difference("Visit.count") do
      post visits_url, params: { visit: { appointment: @visit.appointment, client_id: @visit.client_id } }
    end
  ...
  test "should update visit" do
    patch visit_url(@visit), params: { visit: { appointment: @visit.appointment, client_id: @visit.client_id } }
